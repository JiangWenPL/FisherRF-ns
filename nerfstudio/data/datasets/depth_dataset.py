...
from nerfstudio.data.utils.data_utils import get_depth_image_from_path, get_normal_image_from_path
...
class DepthDataset(InputDataset):
    ...
    def __init__(self, dataparser_outputs: DataparserOutputs, scale_factor: float = 1.0):
        ...
        self.normals_filenames = self.metadata.get("normals_filenames", None)
